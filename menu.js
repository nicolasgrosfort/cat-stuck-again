...
function createContextPage() {
  ...
  contextText.innerHTML = `Humans have lost all their feelings… <br><br>Only cats can bring them back!<br><br>Together, a giraffe and a robot must save the cats stuck in trees and restore hope to the world.`;
...
function showRulesPage() {
  ...
  let rulesList = [
    ...
    { text: 'Move your head 👤 DOWN ↓ to DUCK under dangers', isTitle: false },
    { text: 'ENERGY', isTitle: true },
    { text: 'Raise your right hand ✋ when passing TREES 🌳 to catch ressources for ENERGY ⚡️', isTitle: false },
    { text: 'Catch the leaves 🍃 to keep the GIRAFFE\'s energy', isTitle: false },
    { text: 'Catch the cats 🐱 to keep the ROBOT\'s energy', isTitle: false }
  ];
  
  rulesList.forEach(rule => {
    let ruleItem = document.createElement('p');
